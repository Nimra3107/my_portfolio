  ...
  return (
    ...
    >
      ...
      <div className="h-48 w-full relative overflow-hidden">
        ...
        {/* Overlay on Hover */}
        <div className="absolute inset-0 bg-slate-950/80 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-300 hidden [@media(hover:hover)]:flex items-center justify-center gap-4">
          <a
            href={project.demo}
            target="_blank"
      ...
      <div className="p-5 sm:p-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 mt-5 text-sm font-medium text-indigo-300 hover:text-indigo-200 transition-colors"
        >
          Live Demo

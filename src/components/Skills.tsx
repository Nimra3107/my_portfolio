...
const SERVICES = [
  {
    title: 'Web Design',
    description:
      'Transforming ideas into comprehensive wireframes and mockups. Blending artistic vision with technical expertise to craft user-friendly, visually appealing experiences.',
    icon: <Layout className="w-8 h-8 text-indigo-400" />,
  },
  {
    title: 'Web Application Development',
    description:
      'Building robust, interactive web applications with smooth user experience and efficient backend performance.',
    icon: <Monitor className="w-8 h-8 text-teal-400" />,
  },
  {
    title: 'Responsive Design',
    description:
      'Creating layouts that adapt beautifully across all devices, ensuring consistency and usability everywhere.',
    icon: <Smartphone className="w-8 h-8 text-purple-400" />,
  },
];
  ...
  return (
    <section id="skills" className="py-16 sm:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Top Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16 sm:mb-24">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-sm font-semibold text-indigo-400 uppercase mb-2">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              A comprehensive overview of my technical capabilities. I continuously refine my
              skills to stay aligned with modern industry standards.
            </p>
          ...
          >
            <div className="lg:absolute lg:inset-0 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700/50 p-6 sm:p-8 shadow-2xl flex flex-col justify-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {SKILLS.map((skill, index) => (
                  <div
                    key={index}
                    className="bg-slate-950/50 rounded-lg p-4 border border-slate-800 text-center flex flex-col items-center justify-center"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: index * 0.1 }}
              className="bg-slate-900/50 border border-slate-800 p-6 sm:p-8 rounded-2xl hover:bg-slate-800/50 transition group"
            >
              <div className="w-14 h-14 bg-slate-800 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition">
                {service.icon}
              </div>
